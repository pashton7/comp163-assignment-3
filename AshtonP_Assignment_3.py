...
if event_choice == "Salvage":
    ...
    if has_scanner == True:
        ...
        print("You must choose your next decision wisely: A.) Take no chances and destroy the ship\nB.) Take the chance of saving lives")
    ...
    if has_scanner:
        ...
        print("You come across a battle between smugglers and a bounty hunter. They both have requested of your help, the smugglers offer you a portion of their goods but the bounty hunter you offers you a portion of the bounty reward.")
        ...
        if battle_choice3 == "A":
            print("You decide to team up with the smugglers and you easily take down the bounty hunter. As thanks the smugglers give you a portion of their loot and you salvage the remains of the bounty hunters ship.")
            print("Health: -10, Money: +38")
            ship_health -= 10
            money += 38
        elif battle_choice3 == "B":
            print("You decide that its better to take a portion of the bounty than possibly low value goods. You and the bounty hunter easily overwhelm the smugglers and destroy them. The bounty hunters gives you a portion of the bounty and you salvage the remains of the smugglers ship.")
